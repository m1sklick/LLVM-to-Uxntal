//===-- UxnInstPrinter.cpp - Convert Uxn MCInst to assembly syntax ----===//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints an Uxn MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#define DEBUG_TYPE "asm-printer"
#include "UxnInstPrinter.h"
...
#include "UxnGenAsmWriter.inc"

void UxnInstPrinter::printRegName(raw_ostream &OS, unsigned RegNo) const {
  OS << StringRef(getRegisterName(RegNo)).lower();
}

void UxnInstPrinter::printInst(const MCInst *MI, raw_ostream &O,
...
void UxnInstPrinter::printCondCode(const MCInst *MI, unsigned OpNum,
                                   raw_ostream &O) {
...
void UxnInstPrinter::printAddrModeMemSrc(const MCInst *MI, unsigned OpNum,
                                         raw_ostream &O) {
...
void UxnInstPrinter::printOperand(const MCInst *MI, unsigned OpNo,
                                  raw_ostream &O) {
